...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEGER", "FUNCTION",
  "VARIABLE", "'+'", "'-'", "'*'", "'/'", "UMINUS", "POWER", "'\\n'",
...
{
      15,   -10,     5,     4,   -11,    20,    20,    21,   -11,    -3,
     -11,   -11,    20,    24,    23,   -11,    20,    20,    20,    20,
      20,   -11,    32,   -11,    36,    36,    24,    24,    24,   -11
};
...
{
       0,     0,     5,     0,     6,     0,     0,     0,     2,     0,
       4,     7,     0,    13,     0,     1,     0,     0,     0,     0,
       0,     3,     0,    12,     8,     9,    10,    11,    14,    15
};
...
{
      13,    14,    10,    16,    17,    18,    19,    22,    20,    21,
      11,    24,    25,    26,    27,    28,     1,    12,     2,     3,
       4,    15,     5,     2,     3,     4,     0,     5,     6,    16,
      17,    18,    19,     6,    20,    20,     0,    23,    16,    17,
      18,    19,     0,    20,    18,    19,    29,    20
};

static const yytype_int8 yycheck[] =
{
       5,     6,    12,     6,     7,     8,     9,    12,    11,    12,
       5,    16,    17,    18,    19,    20,     1,    13,     3,     4,
       5,     0,     7,     3,     4,     5,    -1,     7,    13,     6,
       7,     8,     9,    13,    11,    11,    -1,    14,     6,     7,
       8,     9,    -1,    11,     8,     9,    14,    11
};
...
{
       0,     1,     3,     4,     5,     7,    13,    16,    17,    18,
      12,     5,    13,    18,    18,     0,     6,     7,     8,     9,
      11,    12,    18,    14,    18,    18,    18,    18,    18,    14
};
...
#line 1128 "mini_calc.tab.c"
    break;

  case 5: /* expr: INTEGER  */
#line 73 "mini_calc.y"
                                    { (yyval.nPtr) = con((yyvsp[0].dval)); }
#line 1134 "mini_calc.tab.c"
    break;

  case 6: /* expr: VARIABLE  */
#line 74 "mini_calc.y"
                                    { (yyval.nPtr) = id((yyvsp[0].index)); }
#line 1140 "mini_calc.tab.c"
    break;

  case 7: /* expr: INTEGER VARIABLE  */
#line 75 "mini_calc.y"
                                    { (yyval.nPtr) = opr('*', 2, con((yyvsp[-1].dval)), id((yyvsp[0].index)));}
#line 1146 "mini_calc.tab.c"
    break;

  case 8: /* expr: expr '+' expr  */
#line 76 "mini_calc.y"
                                    { (yyval.nPtr) = opr('+', 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1152 "mini_calc.tab.c"
    break;

  case 9: /* expr: expr '-' expr  */
#line 77 "mini_calc.y"
                                    { (yyval.nPtr) = opr('-', 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1158 "mini_calc.tab.c"
    break;

  case 10: /* expr: expr '*' expr  */
#line 78 "mini_calc.y"
                                    { (yyval.nPtr) = opr('*', 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1164 "mini_calc.tab.c"
    break;

  case 11: /* expr: expr '/' expr  */
#line 79 "mini_calc.y"
                                    { (yyval.nPtr) = opr('/', 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1170 "mini_calc.tab.c"
    break;

  case 12: /* expr: '(' expr ')'  */
#line 80 "mini_calc.y"
                                    { (yyval.nPtr) = (yyvsp[-1].nPtr); }
#line 1176 "mini_calc.tab.c"
    break;

  case 13: /* expr: '-' expr  */
#line 81 "mini_calc.y"
                                   { (yyval.nPtr) = opr(UMINUS, 1, (yyvsp[0].nPtr)); }
#line 1182 "mini_calc.tab.c"
    break;

  case 14: /* expr: expr POWER expr  */
#line 82 "mini_calc.y"
                                    { (yyval.nPtr) = opr(POWER, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr));}
#line 1188 "mini_calc.tab.c"
    break;

  case 15: /* expr: FUNCTION '(' expr ')'  */
#line 83 "mini_calc.y"
                                    { (yyval.nPtr) = opr((yyvsp[-3].func), 1, (yyvsp[-1].nPtr));}
#line 1194 "mini_calc.tab.c"
    break;


#line 1198 "mini_calc.tab.c"
